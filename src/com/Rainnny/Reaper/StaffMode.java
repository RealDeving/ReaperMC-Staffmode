...
public class StaffMode extends JavaPlugin {
	...
	private List<String> compassLore() {
		...
		lore.add(ChatColor.translateAlternateColorCodes('&', "§9&lRIGHT CLICK &cto teleport through blocks."));
		lore.add(ChatColor.translateAlternateColorCodes('&', "§9&lLEFT CLICK &cto jump through blocks."));
	...
	private List<String> inspectLore() {
		...
		lore.add(ChatColor.translateAlternateColorCodes('&', "§9&lRIGHT CLICK &cto inspect a player's inventory."));
	...
	private List<String> worldeditLore() {
		...
		lore.add("§9§lLEFT CLICK §cto select position 1");
		lore.add("§9§lRIGHT CLICK §cto select position 2");
	...
	private List<String> freezeLore() {
		...
		lore.add(ChatColor.translateAlternateColorCodes('&', "&9&lRIGHT CLICK &ca player to freeze them."));
	...
	private List<String> randomLore() {
		...
		lore.add(ChatColor.translateAlternateColorCodes('&', "&9&lRIGHT CLICK &cto randomly teleport to a player!"));
		return lore;
	}
	...
	public List<String> vanishLore() {
		...
		lore.add(ChatColor.translateAlternateColorCodes('&', "&9&lRIGHT CLICK &cto toggle your vanish."));
	...
	private List<String> staffOnlineLore() {
		...
		lore.add(ChatColor.translateAlternateColorCodes('&', "&9&lRIGHT CLICK &cto view online staff."));
	...
	public void giveItems(Player player) {
		...
		worldeditMeta.setDisplayName("§9WorldEdit Wand");
	...
	public void onEnable() {
		...
		Bukkit.getScheduler().scheduleSyncRepeatingTask(this, new Runnable() {
			...
			public void run() {
				...
				miningPlayers.clear();
				for(Player online : Bukkit.getOnlinePlayers()) {
					if(online.hasPermission("reaper.staff")) {
